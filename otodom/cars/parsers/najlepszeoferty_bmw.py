...
class UserBmwCarsSearchRequestBuilder(CarSearcher):
    ...
    def include_gasoline(self):
        return replace(self, engine_types=[*self.engine_types, EngineType.GASOLINE],
    ...
    def with_min_doors(self, min_doors):
        return replace(self, min_doors=min_doors,
                       verbose_description=[*self.verbose_description, f'With minimum of {min_doors} doors.'])

    def with_max_doors(self, max_doors):
        return replace(self, max_doors=max_doors,
                       verbose_description=[*self.verbose_description, f'With maximum of {max_doors} doors.'])

    def with_min_mileage(self, min_mileage):
        return replace(self, min_mileage=min_mileage,
                       verbose_description=[*self.verbose_description, f'With minimum of {min_mileage} mileage.'])

    def with_max_mileage(self, max_mileage):
        return replace(self, max_mileage=max_mileage,
                       verbose_description=[*self.verbose_description, f'With maximum of {max_mileage} mileage.'])

    def with_driving_wheel_heating(self):
        return replace(self, generic_equipment=[*self.generic_equipment, GenericEquipment.HEATING_OF_DRIVING_WHEEL],
                       verbose_description=[*self.verbose_description, f'With heating of the driving wheel.'])
